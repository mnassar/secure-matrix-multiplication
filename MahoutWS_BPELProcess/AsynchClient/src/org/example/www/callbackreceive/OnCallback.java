 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static OnCallback parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OnCallback object =
                new OnCallback();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"onCallback".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OnCallback)org.example.www.callbackreceive.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
