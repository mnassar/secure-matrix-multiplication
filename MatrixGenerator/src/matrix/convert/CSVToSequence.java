...
public class CSVToSequence extends
Mapper<LongWritable, Text, IntWritable, VectorWritable> {
	...
	public CSVToSequence(MatrixMeta mm, matrix.meta.Configuration conf)
	{
	...
	public CSVToSequence(String csv_filename)
	{
		csv_file = new String(matrix.meta.Configuration.MATRIX_DIR+"/"+csv_filename+".csv");
		seq_file = new String(matrix.meta.Configuration.MATRIX_DIR+"/"+csv_filename);
	}
	public void convert()
	{
		try {
