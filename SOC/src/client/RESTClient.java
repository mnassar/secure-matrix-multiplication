...
public class RESTClient {
	...
	public static void main(String[] args) throws Exception {
		...
		resourceID = soc.addResource(resource);
		//      System.out.println("Output of get JSON resource object: "+ getResource(service));
		String resourceE = new String(resourceID);
		
		resourceID = soc.addResource(resource);
		//      System.out.println("Output of get JSON resource object: "+ getResource(service));
		String resourceF = new String(resourceID);
		SOCJob job = new SOCJob();
		//job.setExpression("(A*B)+(C+D)*(E+F)");
		...
		aliases.add(alias);
		alias = new SOCResourceAlias(resourceE,"E");
		aliases.add(alias);
		alias = new SOCResourceAlias(resourceF,"F");
		aliases.add(alias);
