 ...
 */
            ...
            /**
            *  AddOnBroker bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddOnBroker
    ...
    public static class Factory{
        ...
        */
        public static AddOnBroker parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddOnBroker object =
                new AddOnBroker();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addOnBroker".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddOnBroker)org.brokerservices.www.matserv.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
